...
Under explicit business assumptions, the observed effect would imply approximately \textbf{\$142k lower monthly gross profit} if rolled out.
...
\section{Decision Risk and Business Impact}

The statistical result was translated into business impact using explicit assumptions.
These assumptions are illustrative and should be replaced with company-specific economics before a production decision.
...
\midrule
Daily users after rollout & 100,000 \\
Analysis horizon & 30 days \\
Revenue per conversion & \$75 \\
Gross margin & 40\% \\
Significance level & 5\% \\
Target power for next test & 80\% \\
\bottomrule
\end{tabular}
\caption{Business impact and planning assumptions}
\end{table}
...
\begin{tabular}{lrr}
\toprule
\textbf{Scenario} & \textbf{Lift} & \textbf{Monthly gross profit impact} \\
\midrule
Observed effect persists & -0.158 pp & -\$142,041 \\
95\% CI lower bound & -0.394 pp & -\$354,411 \\
95\% CI upper bound & +0.078 pp & +\$70,328 \\
\bottomrule
\end{tabular}
\caption{Estimated rollout impact over a 30-day horizon}
\end{table}

The downside case is materially larger than the plausible upside case.
This asymmetry strengthens the recommendation not to launch the new page as-is.

\begin{table}[H]
\centering
\begin{tabular}{lrr}
\toprule
\textbf{Minimum detectable effect} & \textbf{Users per group} & \textbf{Total users} \\
\midrule
0.25 pp & 265,967 & 531,934 \\
0.50 pp & 66,492 & 132,984 \\
1.00 pp & 16,623 & 33,246 \\
\bottomrule
\end{tabular}
\caption{Approximate sample size plan for future tests}
\end{table}
...
\begin{enumerate}
    ...
    \item Use business impact thresholds in addition to statistical significance when making the rollout decision.
